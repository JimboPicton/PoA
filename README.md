...
- Week 6 draws separate travelling arcs for the hips and head, and constructs each foot from heel-to-ball and toe sections so Contact reads as a heel strike, Down as flat support, and Up as a planted-toe push-off.
